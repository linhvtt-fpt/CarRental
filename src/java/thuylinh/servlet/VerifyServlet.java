...
public class VerifyServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String o = request.getParameter("txtOTP").trim();
        ...
        try {
            ...
            if (o.equals(otp)) {
                ...
                boolean result = dao.updateStatus(email);
                if (result) {
                ...
                request.setAttribute("ErrorVerify", "OTP is invalid");
            }
            ...
            log("VerifyServlet SQLException " + e.getMessage());
        } catch (NamingException e) {
            log("VerifyServlet NamingException " + e.getMessage());
        } finally {
